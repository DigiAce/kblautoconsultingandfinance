...
import Posterpage "./pages/Posterpage";
...
import WeeklyFinance from "./pages/ServicePage/WeeklyFinance";
import AuctionChitFund from "./pages/ServicePage/AuctionChit";
import AutoCarRental from "./pages/ServicePage/AutoCarRental";
